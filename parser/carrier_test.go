...
func TestParseCarriers(t *testing.T) {
	rawData := parser.RawCarrierData{
		RawConnectionState: "-1\n2",
		RawCarrierNames:    "3-SinyalKuatLuas,XL Axiata",
	...
	expected := []parser.Carrier{
		{
			...
			CellSignalStrength: parser.CellSignalStrength{
	...
	actual := parser.ParseCarriers(rawData)
